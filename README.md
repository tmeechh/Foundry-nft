...
I go through creating 2 different kinds of NFTs.
...
<br/>
<p align="center">
<img src="./img/sheep.png" width="225" alt="NFT Sheep">
 <img src="./img/crazy.svg" width="225" alt="NFT Wild">
 <img src="./img/calm.svg" width="225" alt="NFT Calm">
...
```
git clone https://github.com/tmeechh/Foundry-nft
cd Foundry-nft
forge install
forge build
```
...
Then, you can get the base64 encoding of the json object by placing the imageURI into `wild_image_uri.json` then running:
...
[![Taiwo Esan Twitter](https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white)](https://twitter.com/tmeech_)
